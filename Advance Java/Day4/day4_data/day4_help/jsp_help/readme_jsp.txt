...
JSP API
jsp-api.jar --- <tomcat>/lib --contains specifications
jasper.jar -- implementations for Tomcat.
...
2.4 config : ServletConfig (used for passing init params) j
...
location inside the translated page : outside  of _jspService & within the translated servlet class.
------------------------
